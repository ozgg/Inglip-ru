...
ActiveRecord::Schema.define(version: 20150412234308) do
  ...
  add_index "dreams", ["name"], name: "index_dreams_on_name", using: :btree
  ...
  create_table "nouns", force: true do |t|
    ...
    t.string   "partitive"
    t.string   "locative"
    t.string   "plural_partitive"
    t.string   "plural_locative"
  end
